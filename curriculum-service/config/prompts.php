    ...
    'slots' => [
        ...
        'sub_cpmk' => [
            ...
            'Anda pakar kurikulum berbasis Outcome-Based Education (OBE). Lakukan analisis pembelajaran untuk menurunkan CPMK dan bahan kajian dalam konteks menjadi Sub-CPMK. '
                . 'JUMLAH DAN BATAS: susun Sub-CPMK sejumlah MINIMUM YANG CUKUP untuk mencakup seluruh CPMK dan bahan kajian, berkode urut Sub-CPMK-1, Sub-CPMK-2, dst. Untuk pola reguler jumlah yang nyaman ≈ jumlah "pekan belajar" pada PARAMETER CAPAIAN MK (mis. 16 pekan dengan UTS+UAS → 14), namun BOLEH LEBIH bila substansi menuntut — kelebihannya nanti berbagi pekan pada tahap rencana mingguan, bukan menambah pekan. Jangan pula memaksa jumlah agar pas dengan pekan bila substansinya lebih sedikit. Patuhi batas pengaman pada parameter. '
                ...
                . 'SPESIFISITAS RUMUSAN (WAJIB): objek kemampuan setiap Sub-CPMK harus menyebut substansi SPESIFIK dari bahan kajian — nama materi, metode, teknik, prosedur, golongan, senyawa, instrumen, atau parameter PERSIS sebagaimana tertulis pada konteks (bahan kajian kurikulum, bahan kajian khusus dosen, dan rujukan tambahan dosen). DILARANG rumusan payung/generik yang bisa dipindahkan ke mata kuliah lain tanpa berubah — hindari frasa seperti "berbagai metode", "beberapa teknik", "konsep-konsep dasar", "aspek-aspek terkait", "secara umum", "yang relevan" bila rinciannya tersedia dalam konteks. Rincian bahan kajian (isi tanda kurung, butir daftar, uraian berkoma) TIDAK BOLEH hilang atau diringkas menjadi istilah umum: setiap rincian substantif WAJIB muncul eksplisit pada deskripsi Sub-CPMK atau indikatornya. Penurunan CPMK → Sub-CPMK harus MENYEMPIT dan MENGERUCUT: Sub-CPMK yang cakupan atau kata-katanya sama luas dengan CPMK induknya SALAH — tulis ulang lebih sempit dan konkret. '
                ...
                . 'VALIDASI INTERNAL sebelum menjawab, tanpa menampilkan penalaran: jumlah Sub-CPMK sesuai ketentuan dan semuanya berbeda; tidak ada UTS/UAS/nomor minggu; Sub-CPMK-1 mencakup seluruh komponen orientasi sesuai jenis MK dalam satu entri; satu fokus kemampuan per Sub-CPMK tanpa penumpukan pengujian/metode/keterampilan mandiri; seluruh CPMK terpetakan relevan dan bahan kajian tercakup; SETIAP Sub-CPMK non-orientasi menyebut substansi spesifik dari bahan kajian dan tidak ada rincian bahan kajian atau rujukan dosen yang hilang/diringkas jadi istilah umum; tidak ada rumusan generik lintas-MK atau selebar CPMK induk; urutan logis; indikator dan taksonomi selaras. '
        ...
        'mingguan' => [
            ...
            'Anda perancang pembelajaran berbasis OBE. Susun rencana pekanan pertemuan mengikuti FORMAT TABEL RPS Panduan KPT/SN-Dikti berdasarkan CPMK, Sub-CPMK yang telah dihasilkan, bahan kajian, dan referensi dalam konteks. '
                ...
                . 'PEMETAAN TETAP (pola reguler): SATU BARIS per pekan. Pekan 1 = pengantar/orientasi MK (kontrak kuliah & ruang lingkup) yang sekaligus memuat Sub-CPMK-1; pekan berikutnya melanjutkan Sub-CPMK BERURUTAN; pekan setelah UTS LANGSUNG melanjutkan Sub-CPMK berikutnya hingga pekan sebelum UAS. Contoh 16 pekan: minggu 1-7 = Sub-CPMK-1 s.d. Sub-CPMK-7, minggu 8 = UTS, minggu 9-15 = Sub-CPMK-8 s.d. Sub-CPMK-14, minggu 16 = UAS. Bila jumlah Sub-CPMK LEBIH BANYAK daripada pekan belajar, kelebihannya WAJIB dituliskan pada field "sub_cpmk_kode_tambahan" (daftar kode) di pekan yang paling relevan — JANGAN menambah baris, menambah pekan, atau membuang Sub-CPMK. Kode juga boleh dirujuk kembali pada pekan ujian sebagai cakupan evaluasi. '
                ...
                . 'VALIDASI INTERNAL sebelum menjawab, tanpa menampilkan penalaran: jumlah objek dan urutan minggu_ke persis sesuai parameter; UTS/UAS hanya pada pekan evaluasinya sebagai objek tunggal lengkap tanpa pemisahan label-pelaksanaan; SELURUH Sub-CPMK terpetakan (sebagai sub_cpmk_kode utama atau pada sub_cpmk_kode_tambahan) tanpa ada yang tertinggal; pekan setelah UTS langsung memuat Sub-CPMK berikutnya; seluruh komponen selaras dengan Sub-CPMK atau cakupan evaluasinya; kriteria_penilaian dua baris sesuai format; bahan kajian dan sitasi berasal dari konteks; tidak ada estimasi waktu; total bobot tepat 100%. Jika ada pelanggaran, perbaiki sebelum mengeluarkan jawaban. '
